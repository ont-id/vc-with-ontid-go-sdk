module github.com/ont-id/vc-with-ontid-go-sdk
...
require (
	...
	github.com/ont-id/verifiable-credential-go-sdk v0.0.0-20220311081452-ca797cb1674d
...
replace github.com/ont-id/verifiable-credential-go-sdk => ../verifiable-credential-go-sdk
